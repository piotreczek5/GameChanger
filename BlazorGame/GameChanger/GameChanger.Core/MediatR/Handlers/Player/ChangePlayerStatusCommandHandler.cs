...
{
    public class ChangePlayerStatusCommandHandler : INotificationHandler<ChangePlayerStatusCommand>
    {
        private readonly IMongoRepository<PlayerDocument, Guid> _playerDocuments;

        public ChangePlayerStatusCommandHandler(IMongoRepository<PlayerDocument, Guid> playerDocuments)
        {
