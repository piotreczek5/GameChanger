...
{
    public class SetBuildingStatusHandler : INotificationHandler<SetBuildingStatusCommand>
    {
        ...
        public SetBuildingStatusHandler(IMongoRepository<SectorDocument, Guid> sectorDocuments, BuildingConfiguration buildingConfiguration, IHubContext<BuildingsHub> notificationHub, IBuildingStatusFactory buildingStatusFactory)
        {
        ...
        public async Task Handle(SetBuildingStatusCommand notification, CancellationToken cancellationToken)
        {
            ...
            var buildingStatus = _buildingStatusFactory.Create(notification.BuildingStatus, notification.TimeToComplete);
