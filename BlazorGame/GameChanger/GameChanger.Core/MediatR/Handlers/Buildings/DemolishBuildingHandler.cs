...
{
    public class DemolishBuildingHandler : BaseSectorHandler,INotificationHandler<DemolishBuildingCommand>
    {
        ...
        public async Task Handle(DemolishBuildingCommand notification, CancellationToken cancellationToken)
        {
            ...
            var destroyingBuildingStatus = _buildingStatusFactory.Create(BuildingStatuses.DESTROYING, DateTime.UtcNow.Add(destroyDelay));
